...
def OPF():
    ...
    #Defining the sets, have added a new set for loads
    ...
    #Fetching the data from the Load_data with data regarding WTP
    ...
    #The constraint has been further changed, to take into consideration that not all loads has to be supplied
    ...
    for n in model.lines :
        print(f"Linee {n} {model.dual[model.FlowBal_const[n]]/model.pu_base:.2f} NOK/MWh")
    print()
